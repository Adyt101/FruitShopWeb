...
<div class="leftnav">
    ...
    <ul style="display:block">
        <li><a href="ListFruitServlet" target="right"><span class="icon-caret-right"></span>水果管理</a></li>
...
<ul class="bread">
    <li><a href="ListFruitServlet" target="right" class="icon-home"> 首页</a></li>
    <li><a href="##" id="a_leader_txt">网站信息</a></li>
    <li><b>当前语言：</b><span style="color:#ff0000;">中文</span>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;切换语言：<a href="##">中文</a> &nbsp;&nbsp;<a href="##">英文</a> </li>
</ul>
<div class="admin">
    <iframe scrolling="auto" rameborder="0" src="ListFruitServlet" name="right" width="100%" height="100%"></iframe>
</div>
